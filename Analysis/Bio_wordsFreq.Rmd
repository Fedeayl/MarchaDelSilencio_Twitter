...
FreqOFgraf <- ggplot(FreqOfi, aes(x=stats::reorder(x=Bio_Oficiales, X=Freq),
                                      y=Freq)) + 
...
FreqTPgraf <- ggplot(FreqTup, aes(x=stats::reorder(x=Bio_Tupamaros, X=Freq),
                                      y=Freq)) + 
...
FreqALgraf <- ggplot(FreqAlt, aes(x=stats::reorder(x=Bio_Alternativos, X=Freq),
                                         y=Freq)) + 
...
jpeg(filename = "Figures/Exploratory figures/DescripcionesBios.jpg", 
